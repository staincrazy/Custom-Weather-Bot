...
from utils.open_weather_map import weather_request
from utils.api_utils import get_random_event, get_city_population_info, get_random_image
...
def _reply_to(message: telebot.types.Message) -> None:
    ...
    try:
        ...
        get_random_image()
        _bot.send_photo(message.chat.id, photo=open("resources/img.jpg", 'rb'))
