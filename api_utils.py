...
def get_city_lng(city_name: str) -> int | None:
    try:
        ...
        logEvent(event=e.__cause__, function=get_city_lng, user_input=city_name)
        return None
...
def get_city_lat(city_name: str) -> int | None:
    try:
        ...
        logEvent(event=e.__cause__, function=get_city_lat, user_input=city_name)
        return None
...
def get_city_population_info(city_name: str | None = None) -> str:
    ...
    try:
        ...
        logEvent(event=e.__cause__, function=get_city_population_info, user_input=city_name)
